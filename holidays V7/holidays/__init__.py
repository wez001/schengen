...
DB_NAME="database.db"       #name for db
...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI']=f'sqlite:///{DB_NAME}'    #this is to let flask know where db is
    db.init_app(app)                #initialise db to be used with this app
